    ...
    <div class="videos">
        ...
        if (isset($videos)) {
            ...
            <div class="videos--video">
                <a class="videos--video--link" target="_blank"
                rel="noopener noreferrer" href="<?php
                    echo 'https://www.youtube.com/watch?v='.$video->id->videoId; ?>">
                    <div class="videos--video--image--wrapper">
                        <img class="videos--video--image"
                        src="<?php echo $infos->thumbnails->medium->url; ?>">
                        <p class="videos--video--image--live
                            videos--video--image--live__<?php
                                echo $infos->liveBroadcastContent
                            ?>">
                            LIVE
                        </p>
                    </div>
                    <p class="videos--video--date">
